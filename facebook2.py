...
facebook_label=Label(root,text="Facebook",fg="Blue",font="Tw_Cen_MT 20 ",borderwidth=0)
facebook_label.grid(row=0,column=0,pady=10,columnspan=2)

delete_box = Entry(root,width=20)
delete_box.grid(row=11,column=1,pady=5)

delete_label= Label(root,text="Update/Delete ID")
...
lastname_label.grid(row=2,column=0,pady=5)
...
City_label.grid(row=5,column=0,pady=5)

Zipcode= Entry(root,width=30)
Zipcode.grid(row=6,column=1,pady=5)

Zipcode_label=Label(root,text="Zipcode")
Zipcode_label.grid(row=6,column=0,pady=5)
...
Gender_label.grid(row=8,column=0,pady=5)
...
def update():
    ...
    lbl=Label(kkk,text="Updated!",font=10)
    lbl.place(x=60,y=10)
    btn=Button(kkk,text="OK",width=10,command=kkk.destroy)
    btn.place(x=60,y=45)
...
del_btn.grid(row=12,column=1,padx=(0,60))

sub_btn= Button(root,text="Submit",command=submit)
sub_btn.grid(row=10,column=1)

query_btn=Button(root,text="Show Records",command=query)
query_btn.grid(row=13,column=1)

edit_btn=Button(root,text="Update",command=edit)
# edit_btn.grid(row=12,column=0,padx=(300,0))
edit_btn.place(x=210,y=358)
